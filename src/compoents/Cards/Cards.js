...
function Cards() {
  ...
  <div class="col">
    <div class="card h-200">
      <img src={react3}class="card-img-top" alt="..."/>
        ...
        <Button variant="dark" href="https://github.com/githubusefull/">Load More</Button>
  ...
  <div class="col">
    <div class="card h-100">
      <img src={react2} class="card-img-top" alt="..."/>
  ...
  <div class="col">
    <div class="card h-100">
      <img src={react5} className="my-4" alt="..."/>
  ...
  <div class="col">
    <div class="card h-100">
      <img src={react7} class="card-img-top" alt="..." />
  ...
  <div class="col">
    <div class="card h-200">
      <img src={react8}class="card-img-top" alt="..."/>
  ...
  <div class="col">
    <div class="card h-100">
      <img src={react10} className="card-img-calculator"alt="..."/>
    ...
    <div class="col">
    <div class="card h-100">
      <img src={react6} className="card-img-calculator"alt="..."/>
    ...
    <div class="col">
    <div class="card h-100">
      <img src={laravel} className="card-img-calculator"alt="..."/>
